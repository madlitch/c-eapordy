...
extern int question_index_lookup(char *category, int value);
...
extern bool invalid_question(char *category, int value);

extern void answer_question(char category[], int value);

extern char* question_answer(char *category, int value);
